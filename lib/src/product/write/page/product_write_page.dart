...
import 'package:clone_project/src/common/components/checkbox.dart';
import 'package:clone_project/src/common/util/image_picker_service.dart';
import 'package:clone_project/src/common/components/product_category_selector.dart';
import 'package:clone_project/src/common/components/textfield.dart';
import 'package:clone_project/src/common/components/trade_location_map.dart';
import 'package:clone_project/src/common/enum/market_enum.dart';
import 'package:clone_project/src/common/layout/common_layout.dart';
...
class _PhotoSelectedView extends GetView<ProductWriteController> {
  ...
  Widget _photoSelectIcon() {
    return GestureDetector(
      onTap: () async {
        var images = await ImagePickerService().pickImages();
